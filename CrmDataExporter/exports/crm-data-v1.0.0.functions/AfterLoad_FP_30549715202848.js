function AfterLoad_FP_30549715202848()
{
	/*
	 ** MLE
	 ** MASAO
	...
	if(objCacDestruc)
	{
	    objCacDestruc.onclick = function fctClicDestruc()
	     {
	...
	{
	    objCacRetourFourn.onclick = function fctClicRetourFourn() 
	     {
	...
	if(objCacTraite)
	{
	    objCacTraite.onclick = function fctClicTraite() 
	     {
	...
	if(objAvoir)
	{
	    objAvoir.onclick = function fctClickAvoirCloture  () {
