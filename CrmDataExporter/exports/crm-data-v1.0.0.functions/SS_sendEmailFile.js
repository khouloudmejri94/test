function SS_sendEmailFile(strFrom,strTo,strCC,strSubject,strBody,MysmtpServer,fNrid,strBCC)
{
	var strReturn: String = String.Empty;
	    ...
	    try {
	        ...
	        MyDoc.SendEmail(strBody, strFrom, strTo, strCC, strBCC, System.Web.Mail.MailPriority.High, System.Web.Mail.MailFormat.Html, strSubject, fNrid, MyParameters, MysmtpServer);
