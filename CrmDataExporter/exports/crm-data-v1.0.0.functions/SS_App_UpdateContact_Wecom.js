function SS_App_UpdateContact_Wecom(pToken,pUserID,pName,pMobile,pEmail,pPosition)
{
	//SS_App_UpdateContact_Wecom
	//NRID  : 42692076586836
	...
	var url = "https://qyapi.weixin.qq.com/cgi-bin/user/update?access_token=" + pToken +"&debug=1";
