function SS_Opp_Fiche_Liaison_sans_Offre(do0_nrid,pRef)
{
	
	
	try {
	    var DBName = CurrentDatabase;
	    var sUrl = "http://srv-crmdev-bdd/ReportServer?%2fSelligent2012%2fFiche_Liaison_sans_Offre&rs:Command=Render&rs:format=PDF&DO0_NRID="+do0_nrid
	    ...
	    var strFileName = "Fiche_Liaison"+date+".pdf";
