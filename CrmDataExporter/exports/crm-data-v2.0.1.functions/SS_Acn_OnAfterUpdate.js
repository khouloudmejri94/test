function SS_Acn_OnAfterUpdate()
{
	//SS_Acn_OnAfterUpdate Maj Fournisseur
	...
	if( CurrentRecord["AcnExtActivation"] == 1 && CurrentRecord["AcnStatus"] == "FAIT" )
	{
	 ...
	 delete myCompany2;
		...
		// SC Edit:
	/*if(Session["MyAcnStatut"]  == true  ) 
	{
	     
	     Session["MyAcnStatut"]   = false ;
	    // if(CurrentRecord['AcnOppReference'] == null || CurrentRecord['AcnOppReference'] =="" )   
	    SS_Acn_AddNewAffaire();
	}
	else Session["MyAcnStatut"]   = false ;*/
