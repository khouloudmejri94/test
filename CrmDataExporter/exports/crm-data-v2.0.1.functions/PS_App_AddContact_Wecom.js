function PS_App_AddContact_Wecom()
{
	//PS_App_AddContact_Wecom
	//NRID : 42331976406658
	...
	if (data.errcode === 0) {
		...
		var jsonCreatContact = top.MyApp.ExecuteServerScript(42992076586836, [vResToken,vUserID,vName,vMobile,vEmail,vPosition]);
