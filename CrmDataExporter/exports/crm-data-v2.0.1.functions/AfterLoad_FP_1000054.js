function AfterLoad_FP_1000054()
{
	
	function fctChangeTableauEcarts()
	{
	...
	if(top.CurrentSetting.nChapMode!="Reset")
	{
	 ...
	 if(objTableauEcarts)
	 {
	      objTableauEcarts.onchange= function fct() { fctChangeTableauEcarts(); }
	 }  
	...
	if(objMnt)
	{
	    objMnt.onclick = function fctClickMtntfrais  () 
	       {
