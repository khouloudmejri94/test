function WS_Cpy_Fiche_Sourcing(pCompany,pOwner,pEmailOwner,pAdress,pPhone,pMobile,pWebsite,pContact,pFunction,pEmail,pSource,pSpecifySource,pProductRange,pProductNature,pActivity,pComment,pRid)
{
	try {
