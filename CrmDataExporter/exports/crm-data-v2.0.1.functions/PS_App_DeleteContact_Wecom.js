function PS_App_DeleteContact_Wecom()
{
	//PS_App_DeleteContact_Wecom
	//NRID : 42412076586836
	...
	if (data.errcode === 0) {
		alert("HAS - Token correctly received and will expire in "+vResExpire/60+" minutes.");
		var jsonCreatContact = top.MyApp.ExecuteServerScript(42332076586836, [vResToken,vUserID]);
